...
//        GMSServices.provideAPIKey(googleMapsApiKey)
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("CyrusTheGreat", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("CyrusTheGreat.sqlite")
